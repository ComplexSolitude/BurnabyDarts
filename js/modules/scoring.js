...
export function renderLiveMatch() {
  ...
  document
    .querySelectorAll("#live-match-content button, #live-match-content input")
    .forEach((el) => {
  ...
  ui.nextGameBtn.disabled =
    state.currentGameIndex === state.fixture.games.length - 1;
